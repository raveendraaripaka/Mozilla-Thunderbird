...
var context_menu  = {
    ...
    encrypt : function() {       
        ...
        //        window.openDialog("chrome://{appname}/content/options.xul", "", "chrome,titlebar,toolbar,centerscreen,modal", result);
        ...
        if (pass.value || prompts.promptPassword(window,"Password Dialog","Enter decryption password or passphrase",pass,"Remember password",remember))
            ...
            try {
                ...
                if (!((target instanceof HTMLInputElement) || (target instanceof HTMLTextAreaElement))) {
                    window.openDialog("chrome://{appname}/content/options.xul", "", "chrome,titlebar,toolbar,centerscreen,modal", {
                        Password : pass.value ,
