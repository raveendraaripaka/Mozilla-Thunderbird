...
var message_body  = {
    ...
    encrypt_mail : function() {
        ...
        if(selection  == null)
        {
            ...
            if(pass == ""){
                ...
                {
                    hint="not provided";
                    var encrypted = message_body.encryptText(selection.toString(), pass, hint);
                    messageBody.textContent = encrypted;
                }
                else{
                    var encrypted_hint = message_body.encryptText(selection.toString(), pass, hint);
        ...
        if(selection  == null)
        {
            ...
            if(pass == ""){
                ...
                if(hint=="")
                {
                    hint="not provided";
                    var encrypted = message_body.encryptText(selection.toString(), pass, hint);
                    encrypted = message_body.hideText(encrypted);
                    
                    messageBody.textContent = encrypted;

                }else{
                    var encryptedastext_hint = message_body.encryptText(selection.toString(), pass);
                    encryptedastext_hint = message_body.hideText(encryptedastext_hint,hint);

                    messageBody.textContent = encryptedastext_hint;
                }
            }
        }
    },    
    ...
    //	Hide text as words
    hideText : function(ciphertext, hint) {
