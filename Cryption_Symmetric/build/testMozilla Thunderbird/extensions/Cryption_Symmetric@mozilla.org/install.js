const APP_DISPLAY_NAME = "Cryption_Symmetric";
const APP_NAME = "Cryption_Symmetric";
const APP_PACKAGE = "/informaction/Cryption_Symmetric";
const APP_VERSION = "1.0";

const APP_PREFS_FILE="defaults/preferences/foxbeansdef.js";
const APP_XPCOM_SERVICE=null;
const APP_JAR_FILE = "Cryption_Symmetric.jar";
...
function myPerformInstall(secondTry) {
  ...
  var chromef = instToProfile ? getFolder("Profile", "extensions/Cryption_Symmetric@mozilla.org/chrome") : getFolder("chrome");
